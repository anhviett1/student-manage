    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.ForeignKey(default=api.app_score.models.get_default_semester, on_delete=django.db.models.deletion.CASCADE, related_name='semester_scores', to='app_semester.semester', verbose_name='Học kỳ')),
            ],
            options={
                'verbose_name': 'score',
                'verbose_name_plural': 'scores',
                'ordering': ['-created_at'],
                'permissions': [('can_view_score_details', 'Có thể xem thông tin điểm số'), ('can_manage_scores', 'Có thể quản lý điểm số'), ('can_view_score_statistics', 'Có thể xem thống kê điểm số'), ('can_export_score', 'Có thể xuất điểm số')],
            },
        ),
    ]
