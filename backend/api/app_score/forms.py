...
class ScoreForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'status': forms.Select(choices=Score.STATUS_CHOICES, attrs={
                'class': 'form-control select2',
                'required': True,
            }),
    ...
    def clean(self):
        ...
        if student and subject and semester:
            ...
            if not Enrollment.objects.filter(
                ...
                raise ValidationError(_('Sinh viên chưa đăng ký môn học này trong học kỳ này hoặc đăng ký chưa được duyệt.'))
