...
class SemesterForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "add_drop_deadline": forms.DateInput(
                attrs={
                    "class": "form-control datepicker",
                    "type": "date",
                }
            ...
            "status": forms.Select(
                choices=Semester.STATUS_CHOICES,
                attrs={
                    "class": "form-control select2",
                    "required": True,
                },
            ),
            "total_credits": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "min": "0",
                    "step": "1",
            ...
            "tuition_deadline": forms.DateInput(
                attrs={
                    "class": "form-control datepicker",
                    "type": "date",
                }
            ),
            "late_fee_start": forms.DateInput(
                attrs={
                    "class": "form-control datepicker",
                    "type": "date",
                }
            ),
            "late_fee_amount": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "min": "0",
                    "step": "1000",
    ...
    def clean_name(self):
        ...
        if (
            Semester.objects.filter(name=name, academic_year=self.cleaned_data.get("academic_year"))
