...
DOCUMENTATION_SECTIONS = {
    'authentication': {
        ...
        'endpoints': [
            ...
            {'path': '/api/v1/token/refresh/', 'method': 'POST', 'description': 'Làm mới JWT token'},
            {'path': '/api/v1/token/verify/', 'method': 'POST', 'description': 'Xác thực JWT token'},
        ]
    },
    'students': {
        ...
        'endpoints': [
            {'path': '/api/v1/students/', 'method': 'GET', 'description': 'Lấy danh sách sinh viên'},
            {'path': '/api/v1/students/{id}/', 'method': 'GET', 'description': 'Lấy thông tin chi tiết sinh viên'},
            {'path': '/api/v1/students/', 'method': 'POST', 'description': 'Tạo sinh viên mới'},
            {'path': '/api/v1/students/{id}/', 'method': 'PUT', 'description': 'Cập nhật thông tin sinh viên'},
    ...
    'teachers': {
        ...
        'endpoints': [
            {'path': '/api/v1/teachers/', 'method': 'GET', 'description': 'Lấy danh sách giáo viên'},
            {'path': '/api/v1/teachers/{id}/', 'method': 'GET', 'description': 'Lấy thông tin chi tiết giáo viên'},
            {'path': '/api/v1/teachers/', 'method': 'POST', 'description': 'Tạo giáo viên mới'},
            {'path': '/api/v1/teachers/{id}/', 'method': 'PUT', 'description': 'Cập nhật thông tin giáo viên'},
