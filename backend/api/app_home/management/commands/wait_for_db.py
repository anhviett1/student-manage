    ...
    def handle(self, *args, **options):
        ...
        while not db_conn and attempt < max_attempts:
            try:
                ...
                logger.warning(f'Database unavailable, attempt {attempt + 1}/{max_attempts}: {str(e)}')
                self.stdout.write(f'Database unavailable, attempt {attempt + 1}/{max_attempts}, waiting 2 seconds...')
