...
class Class(models.Model):
    ...
    class_id = models.CharField(
        max_length=20, unique=True, verbose_name="Mã lớp", default="L001", null=False, blank=False
    )
    # Thông tin lớp học
    class_name = models.CharField(
        max_length=200, verbose_name="Tên lớp", default="Lớp mặc định", null=False, blank=False
    )
    ...
    credits = models.PositiveIntegerField(
        verbose_name="Số tín chỉ", default=3, null=False, blank=False
    )
