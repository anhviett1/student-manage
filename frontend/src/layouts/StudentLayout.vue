<template>
  <div class="student-layout">
    ...
    <aside class="sidebar">
      <div class="logo">
        <router-link to="/student-dashboard">🎓 Student Manager</router-link>
      </div>

      <nav class="menu">
        <router-link to="/student-dashboard" class="menu-item">Trang chủ</router-link>
        <router-link to="/profile" class="menu-item">Hồ sơ</router-link>
        <router-link to="/scores" class="menu-item">Xem điểm</router-link>
...
const username = computed(() => localStorage.getItem('username') || 'Sinh viên')
const pageTitle = computed(() => route.meta.title || 'Cổng thông tin sinh viên')
</script>
