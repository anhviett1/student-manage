  ...
  <div class="dashboard-wrapper">
    ...
    <aside class="dashboard-sidebar">
      <div class="sidebar-header">
        <div class="logo-container">
          <router-link to="/teacher-dashboard" class="logo">
            <span>Student Management</span>
          </router-link>
        </div>
      </div>
      <nav class="dashboard-menu">
        <router-link to="/teacher-dashboard" class="menu-item">Bảng điều khiển</router-link>
        <router-link to="/profile" class="menu-item">Hồ sơ</router-link>
        <router-link to="/students" class="menu-item">Sinh viên</router-link>
        <router-link to="/classes" class="menu-item">Lớp học</router-link>
    ...
    <main class="dashboard-main">
      ...
      <div class="dashboard-content">
        ...
        <p>Đây là trang quản trị dành cho giáo viên.</p>
        <route-view />
      </div>
    </main>
  </div>
