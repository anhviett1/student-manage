  ...
  <div class="dashboard-wrapper">
    ...
    <aside class="dashboard-sidebar">
      ...
      <nav class="dashboard-menu">
        <router-link to="/student-dashboard" class="menu-item">Quản lý Sinh viên</router-link>
        <router-link to="/teacher-dashboard" class="menu-item">Quản lý Giảng viên</router-link>
        <router-link to="/profile" class="menu-item">Hồ sơ cá nhân</router-link>
        <router-link to="/classes" class="menu-item">Quản lý Lớp học</router-link>
        <router-link to="/subjects" class="menu-item">Quản lý Môn học</router-link>
        <router-link to="/enrollments" class="menu-item">Quản lý Ghi danh</router-link>
        <router-link to="/semesters" class="menu-item">Quản lý Học kỳ</router-link>
        <router-link to="/scores" class="menu-item">Quản lý Điểm số</router-link>
        <router-link to="/schedules" class="menu-item">Thời khóa biểu</router-link>
        <router-link to="/departments" class="menu-item">Khoa</router-link>
    ...
    <main class="dashboard-main">
      <div class="dashboard-topbar">
        ...
        <div class="topbar-actions">
          ...
          <Button label="Django Admin" icon="pi pi-external-link" text class="action-icon" @click="goToDjangoAdmin" />
        </div>
      </div>
      <div class="dashboard-content">
        <h1>Chào mừng Admin!</h1>
        <p>Đây là trang quản trị với đầy đủ chức năng dành cho admin.</p>
        <ProfileView />
      </div>
    </main>
  </div>
...
const username = computed(() => {
  // You can get username from authStore or useAppEvents
