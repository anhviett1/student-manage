...
const menuItems = computed(() => {
  ...
  if (userRole.value === 'admin') {
    return [
      { to: '/admin/users', label: 'Quản lý Người dùng', icon: 'pi pi-users', 
        children: [
      ...
      { to: '/admin/students', label: 'Quản lý Sinh viên', icon: 'pi pi-user', 
        children: [
      ...
      { to: '/admin/teachers', label: 'Quản lý Giảng viên', icon: 'pi pi-user-plus', 
        children: [
